...
class prossesAuth {
  ...
  Future register(BuildContext context, String name, String email,
    ...
    Uri urlRegister = Uri.parse("http://172.10.50.41:4000/auth/register");
  ...
  Future verify(BuildContext context, String email, String otp) async {
    Uri urlVerification = Uri.parse("http://172.10.50.41:4000/auth/verify/");
  ...
  Future login(BuildContext context, String email, String password) async {
    Uri urlLogin = Uri.parse("http://172.10.50.41:4000/auth/login/");
  ...
  Future forgotPassword(BuildContext context, String email) async {
    Uri urlForgotPassword =
        Uri.parse("http://172.10.50.41:4000/auth/forgotPassword");
  ...
  Future newPassword(BuildContext context, String email, String password,
    ...
    Uri urlNewPassword =
        Uri.parse("http://172.10.50.41:4000/auth/reset-password");
